    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <div class="collapse ms-3" id="collapseTables">
          ...
          <li class="nav-item">
            <a class="nav-link text-white " href="{{route('parentadmin.index')}}">
              ...
              <span class="nav-link-text ms-1">Cha mẹ</span>
            </a>
          </li>
        </div>
        <li class="nav-item">
          <a class="nav-link text-white "data-bs-toggle="collapse" href="#collapse2">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">Quản lý tài khoản</h6>
        </li>
        <li class="nav-item">
