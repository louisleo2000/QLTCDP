 <!-- Navbar -->
 <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 blur shadow-blur mt-4 left-auto top-1 z-index-sticky border-radius-xl"
     navbar-scroll="true">
     <div class="container-fluid py-1 px-3">
         <nav aria-label="breadcrumb">
             <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                 <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Trang</a></li>
                 <li class="breadcrumb-item text-sm text-dark active" aria-current="page">@if(isset($title)) {{$title}} @else Dashboard @endif</li>
             </ol>
             <h6 class="font-weight-bolder mb-0">@if(isset($title)) {{$title}} @else Dashboard @endif</h6>
         </nav>
