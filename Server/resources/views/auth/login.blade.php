                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('login') }}" class="text-start">
                                    ...
                                    <div class="form-check form-switch d-flex align-items-center mb-3">
                                        ...
                                        <label class="form-check-label mb-0 ms-2" for="rememberMe">Nhớ đăng nhập</label>
                                    </div>
                    ...
                    <div class="row align-items-center justify-content-lg-between">
                        <div class="col-12 col-md-6 my-auto">
                            <div class="copyright text-center text-sm text-white text-lg-start">
                                ...
                                <a href="https://www.creative-tim.com" class="font-weight-bold text-white"
                                    target="_blank">Luu Hoang Long</a>
                                for a better web.
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                                <li class="nav-item">
                                    <a href="https://www.facebook.com/LongLwu2000/" class="nav-link text-white"
                                        target="_blank">Luu Hoang Long</a>
                                </li>
                                <li class="nav-item">
