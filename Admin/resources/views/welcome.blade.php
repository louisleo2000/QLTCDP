...
<head>
    ...
    <title>Quản lý tiêm chủng trẻ em</title>
    ...
    <div
        ...
        @if (Route::has('login.admin'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                ...
                @else
                    <a href="{{ route('login.admin') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Đăng
                        nhập</a>

                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                            class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Đằng ký</a>
                    @endif
                @endauth
            </div>
        @endif
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
               <img src="{{asset('logo.png')}}" alt="" style="width: 300px;">
            </div>
            <h1 style="color: white">HỆ THỐNG QUẢN LÝ TIÊM CHỦNG CHO TRẺ EM</h1>
